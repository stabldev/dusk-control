...
internal static partial class WmiHelper
{
  ...
  public static unsafe void SetBrightness(uint brightness)
  {
    ...
    var getMethod = (delegate* unmanaged[Stdcall]<IntPtr, IntPtr, int, IntPtr*, IntPtr*, int>)vtableClass[20];
    ...
    var spawnInstance = (delegate* unmanaged[Stdcall]<IntPtr, int, IntPtr*, int>)vtableInSig[14];
    ...
    VARIANT varTimeout = new VARIANT { vt = 19 /* VT_UI4 */, ulVal = 0 };
